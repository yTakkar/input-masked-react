  ...
  _createClass(SingleInput, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          value = _props2.value,
          style = _props2.style,
          rest = _objectWithoutProperties(_props2, ['separator', 'isLastChild', 'inputStyle', 'focus', 'isDisabled', 'error', 'errorStyle', 'focusStyle', 'disabledStyle', 'shouldAutoFocus', 'isInputNum', 'value', 'style']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', _extends({
          style: Object.assign((0, _helpers.isObject)(style) && style, { width: '1em', textAlign: 'center' }, inputStyle, focus && (0, _helpers.isObject)(focusStyle) && focusStyle, isDisabled && (0, _helpers.isObject)(disabledStyle) && disabledStyle, error && (0, _helpers.isObject)(errorStyle) && errorStyle),
          className: this.getClasses(focus && focusStyle, isDisabled && disabledStyle, error && errorStyle),
