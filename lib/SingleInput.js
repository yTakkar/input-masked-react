  ...
  function SingleInput() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          SingleInput.__proto__ ||
          Object.getPrototypeOf(SingleInput)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _extends(
              {
                style: Object.assign(
                  (0, _helpers.isObject)(style) && style,
                  { width: '1em', textAlign: 'center' },
                  inputStyle,
                  focus && (0, _helpers.isObject)(focusStyle) && focusStyle,
                  value &&
                    (0, _helpers.isObject)(valueEnteredStyle) &&
                    valueEnteredStyle,
                  isDisabled &&
                    (0, _helpers.isObject)(disabledStyle) &&
                    disabledStyle,
                  error && (0, _helpers.isObject)(errorStyle) && errorStyle
                ),
