  ...
  function MaskedInput() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          MaskedInput.__proto__ ||
          Object.getPrototypeOf(MaskedInput)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              ...
              className: !(0, _helpers.isObject)(containerStyle)
                ? containerStyle
                : '',
            },
            this.renderInputs()
...
MaskedInput.defaultProps = {
  ...
  separator: _react2.default.createElement('span', null, '\xA0'),
  defaultValues: [],
};
